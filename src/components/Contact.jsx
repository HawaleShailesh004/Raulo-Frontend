        ...
        >
          ...
          <div className="flex flex-col text-left">
            ...
            {errors.businessDetails && (
              <p className="text-red-400 text-sm mt-1">{errors.businessDetails}</p>
            )}
          </div>
          ...
          {/* Error Message */}
          {errors.form && (
            <p className="text-red-400 font-semibold text-center">{errors.form}</p>
          )}
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="mt-4 px-6 py-3 bg-gradient-to-r from-yellow-400 to-pink-500 text-black font-bold rounded-xl shadow-lg hover:opacity-90 transition disabled:opacity-50"
          >
          ...
          {/* Success Message */}
          {success && (
            <p className="text-green-400 font-semibold text-center mt-4">{success}</p>
          )}
        </motion.form>
      </section>
    </div>
